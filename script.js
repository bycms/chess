...
Rules:
1. Pieces: R (Rook), N (Knight), B (Bishop), Q (Queen), K (King), P (Pawn). Uppercase for white, lowercase for black. You are moving the ${model === 'DeepSeek-R1-Distill-Llama-8B' ? 'white' : 'black'} pieces.
2. Moves must follow standard chess rules. Never move a piece to where 
3. Respond with your move in the format "from [row,col] to [row,col]". For example, "from [1,2] to [3,4]".
